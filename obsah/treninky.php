            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
						...
						<li><a href="treninky.php">Tréninky</a></li>
    ...
    <section id="testimonial2">
        <div class="container">
            <div class="row">
				 ...
				 <h2>Seznam trenérů:</h2>
                 <!--content-->
				<?php
				include('../admin/connect.php');
				$prikaz="SELECT * FROM galerietreneru";
				$vysledek=mysqli_query($db,$prikaz);
			while($pole = mysqli_fetch_assoc($vysledek)){
				$idtrenera=$pole['id'];
				$jmeno=$pole['jmeno'];
				$prijmeni=$pole['prijmeni'];
				echo  "<a href='treneriinfo.php?id=$idtrenera'><strong><p>$jmeno $prijmeni</p></strong></a>";
			}
				?>
			<a href="treneri/pekarek.php"><p><strong>Ladislav Pekárek</strong></p></a>
			
			<?php
			include('../admin/connect.php');
            $query="SELECT * FROM treninky";
            $result=mysqli_query($db,$query);
			while($rows=mysqli_fetch_assoc($result))
			{?>
				<!--<div class="Obsah">--><h2><?php echo $rows['predmet'];?></h2>
				<p><?php echo $rows['obsah'];?></p><!--</div>--> 
        	<?php
		  }
