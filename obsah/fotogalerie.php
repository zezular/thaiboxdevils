        ...
        <div class="container">
    			...
    			<?php 
      			  ...
      			  while($row = $query->fetch_assoc()){ 
           			 $imageThumbURL = '../admin/web/uploads/'.$row["file_name"]; 
           			 $imageURL = '../admin/web/uploads/'.$row["file_name"]; 
   				 ?>
...
<?php }*/ ?> 
                 ...
                 <?php/*
					 ...
					 $result = mysqli_query($db, "SELECT * FROM fotogalerie");
				 ?>
				 <div class="Obsah">
		<div class='row'>  
			<?php
				while ($row = mysqli_fetch_array($result)) {   		         
				 ...
				 echo "<img id='myImg'  height=235 width=350 src='../admin/web/obrazkyfotogalerie/".$row['url']."' style='width:100%;max-width:300px' >";
