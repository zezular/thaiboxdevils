...
<body>
  ...
  include('../admin/connect.php');
	 $idprispevku=$_GET['id'];
	 $prikaz="SELECT * FROM galerietreneru WHERE id='$idprispevku'";
	...
	while($pole = mysqli_fetch_assoc($vysledek)){
		...
		$licence=$pole['licence'];	
		$seminar=$pole['seminar'];	
		$kontakt=$pole['kontakt'];	

	    $prikaz2="SELECT * FROM galerietreneru WHERE textobrazku='$idprispevku'";
	   ...
	   while($pole2 = mysqli_fetch_assoc($vysledek2)){
		...
		echo " <table border='0' cellpadding='10' 
         			<tr><th colspan='2'> <img src=../admin/web/obrazky/$url2 ></th></tr>
					<tr><th><h3>Jméno:</h3></th><td>$jmeno</td></tr>
					<tr><th><h3>Přijmení:</h3></th><td>$prijmeni</td></tr>
					<tr><th><h3>Odbornosti:</h3></th><td>$licence</td></tr>
					<tr><th><h3>Seminář:</h3></th><td>$seminar</td></tr>
					<tr><th><h3>Kontakt:</h3></th><td>$kontakt</td></tr>
			  </table>";
		}
	}
		if($url2==""){
		...
		echo  "<a href='treninky.php'><strong><p>Zpět</p></strong></a>";
