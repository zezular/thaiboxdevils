    ...
    <section id="testimonial2">
        <div class="container">
            <div class="row">
				...
				<h3>Seznam zápasníků</h3>
				<?php/*
				include('../admin/connect.php');
				$prikaz="SELECT * FROM galeriebojovniku";
				$vysledek=mysqli_query($db,$prikaz);
			while($pole = mysqli_fetch_assoc($vysledek)){
				$idzapasnika=$pole['id'];
				$jmeno=$pole['jmeno'];
				$prijmeni=$pole['prijmeni'];
				echo  "<a href='zapasnikinfo.php?id=$idzapasnika'><strong><p>$jmeno $prijmeni</p></strong></a>";
			}*/
				?>
				
				
				<div class="galery">
				    <a href="bojovnici/JaromirJahoda/JaromirJahoda-kopie.jpg" data-lightbox="mygallery"><img src="bojovnici/JaromirJahoda/JaromirJahoda-kopie-small.jpg" alt="Jahoda"></a>
				    <a href="bojovnici/JaromirJahoda/Jahoda.php"><strong><p>Jaromír Jahoda</p></strong></a>
				</div>
				<div class="galery">
				    <a href="bojovnici/Cermak/MichalCermak.JPG" data-lightbox="mygallery"><img src="bojovnici/Cermak/MichalCermak-small.JPG" alt="Čermák"></a>
				    <a href="bojovnici/Cermak/cermak.php"><strong><p>Michal Čermák</p></strong></a>
				</div>
				<div class="galery">
				    <a href="bojovnici/Pekarek/Ladislav Pekárek.JPG" data-lightbox="mygallery"><img src="bojovnici/Pekarek/Ladislav Pekárek-small.JPG" alt="Čermák"></a>
				    <a href="bojovnici/Pekarek/pekarek.php"><strong><p>Ladislav Pekárek</p></strong></a>
				</div>
				<div class="galery">
				    <a href="bojovnici/Flieger/LukasFlieger-kopie.jpg" data-lightbox="mygallery"><img src="bojovnici/Flieger/LukasFlieger-kopie-small.jpg" alt="2007"></a>
				    <a href="bojovnici/Flieger/flieger.php"><strong><p>Lukáš Flieger</p></strong></a>
				</div>
				
				<div class="galery">
				    <a href="bojovnici/Novak/TomasNovak-kopie.jpg" data-lightbox="mygallery"><img src="bojovnici/Novak/TomasNovak-kopie-small.jpg" alt="Čermák"></a>
				    <a href="bojovnici/Novak/novak.php"><strong><p>Tomáš Novák</p></strong></a>
				</div>
            </div>
        </div>
    </section>
