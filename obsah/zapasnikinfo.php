...
<body>
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="../index.php"><strong><img width="90px" src="../img/devils.png" ></strong></a></li>
						...
						<li><a href="galerie.php">Bojovníci</a></li>
    ...
    <section id="testimonial2">
        <div class="container">
            <div class="row">
		      	 <h2>Galerie Bojovníků</h2><br>
				 <?php
  include('../admin/connect.php');
	 $idprispevku=$_GET['id'];
	 $prikaz="SELECT * FROM galeriebojovniku WHERE id='$idprispevku'";
	 $vysledek=mysqli_query($db,$prikaz);
	while($pole = mysqli_fetch_assoc($vysledek)){
		$idprispevku=$pole["id"];
		$jmeno=$pole['jmeno'];
		$prijmeni=$pole['prijmeni'];
		$prezdivka=$pole['prezdivka'];
		$datumnarozeni=$pole['datumnarozeni'];
		$styl=$pole['styl'];
		$vaha=$pole['vaha'];
		$vyska=$pole['vyska'];
		$trenujeod=$pole['trenujeod'];
		$profizapasy=$pole['profizapasy'];
		$pvitezstvi=$pole['pvitezstvi'];
		$pvitezstviko=$pole['pvitezstviko'];
		$premizy=$pole['premizy'];
		$tituly=$pole['tituly'];
		$amaterskezapasy=$pole['amaterskezapasy'];
		$vitezstvi=$pole['vitezstvi'];
		$vitezstviko=$pole['vitezstviko'];
		$remizy=$pole['remizy'];
		$amatersketituly=$pole['amatersketituly'];
		$url=$pole['url'];
		$textobrazku=$pole['textobrazku'];
	    
        $jmenoakce=$_GET['jmeno']; 
	    $prikaz="SELECT url FROM galeriebojovniku WHERE textobrazku='$jmenoakce'";
	   $vysledek=mysqli_query($db,$prikaz);
	   while($pole = mysqli_fetch_assoc($vysledek)){
		$url=$pole['url'];
        }
		echo " <table border='2' cellpadding='5' cellspacing='4'>
         			<tr><th> <img  height=235 width=350 src=obrazky/'.$url.' ></th></tr>
					<tr><th><h3>Jméno</h3></th><td><p>$jmeno</p></td></tr>
					<tr><th><h3>Přijmení</h3></th><td><p>$prijmeni</p></td></tr>
					<tr><th><h3>Přezdívka</h3></th><td><p>$prezdivka</p></td></tr>
					<tr><th><h3>Datum Narození</h3></th><td><p>$datumnarozeni</p></td></tr>
					<tr><th><h3>Styl</h3></th><td><p>$styl</p></td></tr>
					<tr><th><h3>Váha</h3></th><td><p>$vaha</p></td></tr>
					<tr><th><h3>Výška</h3></th><td><p>$vyska</p></td></tr>
					<tr><th><h3>Trénuje od roku</h3></th><td><p>$trenujeod</p></td></tr>
					<tr><th><h3>Profi zápasy</h3></th><td><p>$profizapasy</p></td></tr>
					<tr><th><h3>Vítězství</h3></th><td><p>$pvitezstvi</p></td></tr>
					<tr><th><h3>Vítězství K.O.</h3></th><td><p>$pvitezstviko</p></td></tr>
					<tr><th><h3>Remézy</h3></th><td><p>$premizy</p></td></tr>
					<tr><th><h3>Tituly</h3></th><td><p>$tituly</p></td></tr>
					<tr><th><h3>Amatérské Zápasy</h3></th><td><p>$amaterskezapasy</p></td></tr>
					<tr><th><h3>Vítězství</h3></th><td><p>$vitezstvi</td></tr>
					<tr><th><h3>Vítězství K.O.</h3></th><td><p>$vitezstviko</p></td></tr>
					<tr><th><h3>Remízy</h3></th><td><p>$remizy</p></td></tr>
					<tr><th><h3>Amatérské Tituly</h3></th><td><p>$amatersketituly</p></td></tr>
			   </table>";
		...
		echo  "<a href='galerie.php'><strong><p>Zpět</p></strong></a>";
